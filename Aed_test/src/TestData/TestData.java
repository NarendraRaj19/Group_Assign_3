     ...
     public void test2(){
      ...
      //  PersonDirectory pd1 = department1.getPersonDirectory();
       ...
       fp1.setFacultyRatings(9);
        ...
        fp6.AssignAsTeacher(courseoffer6);
        
        courseoffer7.AssignAsTeacher(fp7);
        fp7.AssignAsTeacher(courseoffer7);
        
        courseoffer8.AssignAsTeacher(fp8);
        fp8.AssignAsTeacher(courseoffer8);
        
        courseoffer9.AssignAsTeacher(fp9);
        fp9.AssignAsTeacher(courseoffer9);
        
        courseoffer10.AssignAsTeacher(fp10);
        fp10.AssignAsTeacher(courseoffer10);
        
        courseoffer11.AssignAsTeacher(fp11);
        fp11.AssignAsTeacher(courseoffer11);
        ...
        Alumni al = new Alumni();
        al.setStudentProfile(sp);
        al.setGradutationYear(2014);
        al.setEmp(em);
        al.setPosition("SDE");
        al.setSalaryRange(250000);
        al.setPromotions(5);
        al.setWorkExp(7);
        al.calculateAMG();
       ...
       // System.out.println("");
        ...
        Alumni al1 = new Alumni();
        al1.setStudentProfile(sp1);
        al1.setGradutationYear(2016);
        al1.setEmp(em);
        al1.setPosition("SDE2");
        al1.setSalaryRange(139000);
        al1.setPromotions(5);
        al1.setWorkExp(6);
        al1.calculateAMG();
       ...
       // System.out.println("");
        ...
        al5.setGradutationYear(2015);
        al5.setEmp(em);
        al5.setPosition("SDE3");
        al5.setSalaryRange(195000);
        al5.setPromotions(5);
        al5.setWorkExp(6);
        al5.calculateAMG();
        ...
        for(StudentProfile spp1 : asp){
            ...
            for(int i=0 ; i < as111.size(); i++){
                as111.get(i).assignGradeToStudent("C-");
            }
        }
