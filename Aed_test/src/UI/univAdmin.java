...
public class univAdmin extends javax.swing.JPanel {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                            .addComponent(UsernameTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 600, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(LoginButton, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(PasswordField, javax.swing.GroupLayout.PREFERRED_SIZE, 600, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        AddstupanelLayout.setHorizontalGroup(
            ...
            .addGroup(AddstupanelLayout.createSequentialGroup()
                ...
                .addGroup(AddstupanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(AddstuNameLbl, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(AddStuIdLbl, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(AddstudeptLbl, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(AddstucouLbl, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(34, 34, 34)
                .addGroup(AddstupanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(AddProfPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(AddProfPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(AddProfPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(AddProfDeptcb1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(AddProfcoucom, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(AddProfPanelLayout.createSequentialGroup()
                        .addGap(324, 324, 324)
        ...
        InUnvTabPane.addTab("Alumni Details", ShAlmn);
...
//            }
   ...
   // System.out.println("Std"+new Helper().addStudent(d, "MM", "101", "2", co));
    ...
    private void AddProfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddProfActionPerformed
        ...
        if(!profid.equals("") || !profid.isEmpty()){
...
//            CrScMtrxLbl.setVisible(true);
           // CsMScrPnl.setVisible(true);
...

            {
                ...
                dataset.setValue(frk.get(i).getPerson().getPersonId(), frk.get(i).getFacultyRatings());
                model.addRow(row);
...

            {
                ...
                dataset1.setValue(rco.get(i).getName(), rco.get(i).getRating());
                model1.addRow(row);
           ...
           ArrayList<Double> values = careerSuccesMetricRank(map.get("Information Systems"));
            ...
            DecimalFormat df = new DecimalFormat("###.##");
             if(gpa < 8.4 && CGM > 5.0 ){
                 JOptionPane.showMessageDialog(this, "Having a below average CGPA "+gpa+" doesnt affect the student's Industry Performance score "+df.format(CGM)+" !!");
...
//            System.out.println("Having a below average CGPA doesnt affect the student's Industry Performance!!");
             ...
             //else if(gpa > 8.4 && CGM < 5.0){
                   ...
                   JOptionPane.showMessageDialog(this, "Having a very good CGPA "+gpa+" doesnt guarantee Industry Success "+df.format(CGM)+" !!");
                   
        }
           // CsMTxtArea.setText(sb.toString());

            JFreeChart chart = ChartFactory.createPieChart("Professor Ranking Chart", dataset, true, true, true);
       // JFreeChart chart1 = ChartFactory.createPieChart("Prof Ranking Chart", dataset1, true, true, true);

        ChartFrame yourFrame = new ChartFrame("Professor Ranking Chart", chart);
    //    yourFrame = new ChartFrame("Course Ranking Chart", chart1);
        yourFrame.setSize(450, 450);
        yourFrame.setVisible(true);
        
         JFreeChart chart1 = ChartFactory.createPieChart("Course Ranking Chart", dataset1, true, true, true);
       // JFreeChart chart1 = ChartFactory.createPieChart("Prof Ranking Chart", dataset1, true, true, true);

        ChartFrame yourFrame1 = new ChartFrame("Course Ranking Chart", chart1);
    //    yourFrame = new ChartFrame("Course Ranking Chart", chart1);
        yourFrame1.setSize(450, 450);
        yourFrame1.setVisible(true);  
        }
        if(selval.equals("Computer Science"))
        {
