...
public class std extends javax.swing.JPanel {
   ...
   String profName;
    ...
    private void initComponents() {
        ...
        RateProfessorbtn.setBackground(new java.awt.Color(102, 102, 102));
        RateProfessorbtn.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(PasswordField, javax.swing.GroupLayout.DEFAULT_SIZE, 600, Short.MAX_VALUE)
...
//        }
    ...
    private void OKbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKbtnActionPerformed
        ...
        System.out.println("Inside ratemY");
        Boolean flag = false;
        DepartmentDirectory dd = TestData.getInstance().getDd();
        List<Department> list = dd.getDd();
        for(Department d : list)
        {
            int fsize = d.getFacultyDirectory().getTeacherlist().size();
            for(int i=0 ; i < fsize ; i++){
               if(d.getFacultyDirectory().getTeacherlist().get(i).getPerson().getPersonId().equals(profName)){
                d.getFacultyDirectory().getTeacherlist().get(i).setFacultyRatings(Integer.parseInt(selectValue));
                
                flag=true;
                System.out.println("Professor Ratings: "+d.getFacultyDirectory().getTeacherlist().get(i).getFacultyRatings());
                break;
            } 
