                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(PasswordField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 600, Short.MAX_VALUE)
...
DepartmentDirectory dd = TestData.getInstance().getDd();
        ...
        for(Department d:list){
            int courseSize = d.getCourseCatalog().getCourseList().size();
            for(int i=0;i<courseSize;i++){
               for(Map.Entry me :  map1.entrySet()){
                   String key = (String) me.getKey();
                   String val = (String) me.getValue();
                   if(d.getCourseCatalog().getCourseList().get(i).getName().equals(key)){
                    d.getCourseCatalog().getCourseList().get(i).setRating(Integer.parseInt(me.getValue().toString()));
                    System.out.println("TT jkk");
                    flag=true;
                    System.out.println("Course Ratings: "+d.getCourseCatalog().getCourseList().get(i).getRating());
                    //break;
